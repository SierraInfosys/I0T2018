    ...
    1: [function () {
        ...
        (function () {
            $(document).ready(function () {
                ...
                g = function () {
                    var k, m, p;
                    m = 1280 > $(window).width(), p = m ? _Mathfloor($("#chart-sales-status").parent().width()) : 150, k = [45, 56, 76, 48, 78, 99, 70, 90, 79, 102, 74, 90, 98, 120, 90, 102, 74, 90, 98, 120, 90, 77, 103, 105, 120], $("#chart-sales-status").sparkline(k, {
                        type: "bar",
                        height: 50,
                        width: "100%",
                        barWidth: 4 * p / 6 / k.length,
                        barSpacing: 2 * p / 6 / k.length,
                    ...
                    }), p = m ? _Mathfloor($("#chart-users-status").parent().width()) : 150, $("#chart-users-status").sparkline([40, 60, 30, 50, 80, 100, 70, 90], {
                        type: "line",
                        height: 50,
                        width: p,
                        lineWidth: 2,
                    ...
                    }), p = m ? _Mathfloor($("#chart-impressions-status").parent().width()) : 150, $("#chart-impressions-status").sparkline([440, 400, 460, 400, 250, 330, 350, 370], {
                        type: "line",
                        height: 50,
                        width: p,
                        lineWidth: 2,
                    ...
                    }), p = m ? _Mathfloor($("#chart-downloads-status").parent().width()) : 150, $("#chart-downloads-status").sparkline([344, 280, 285, 311, 244, 232, 188], {
                        type: "line",
                        height: 50,
                        width: p,
                        lineWidth: 2,
                ...
                }, h = void 0, $(window).on("resize", function () {
                    clearTimeout(h), h = setTimeout(g, 500)
                }), g(), $("#sparkline-chart-line").sparkline([5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7], {
                    type: "line",
                    height: "25px",
                    width: "80px",
