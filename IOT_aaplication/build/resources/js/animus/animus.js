(function b(c, d, g) {
    ...
    1: [function () {
        "use strict";
        (function () {
            var g = [].indexOf || function (h) {
                for (var j = 0, k = this.length; j < k; j++)
                    if (j in this && this[j] === h) return j;
                return -1
            };
            (function (h) {
                h.animus = function (m) {
                    var p;
                    p = {}, p.duration = 600, p.defaults = {
                        opacity: 1,
                        rotationX: 0,
                        rotationY: 0,
                        rotationZ: 0,
